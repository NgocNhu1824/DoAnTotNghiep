...
export class UserImportParserHelper {
  private static readonly REQUIRED_HEADERS = ['email', 'fullname', 'rolecode', 'campuscode'];
      ...
      if (headerRowIndex < 0) {
        reject(
          new BadRequestException(
            'Header row not found. Please use template columns: email, fullName, roleCode, campusCode.',
          ),
        );
        return;
      }
